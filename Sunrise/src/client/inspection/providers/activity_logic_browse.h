...
[[nodiscard]] inline bool contains_case_insensitive(std::string_view text,
...
[[nodiscard]] inline bool matches(const BrowseSummary& summary,
                                  std::string_view query) {
...
[[nodiscard]] inline View build(std::span<const BrowseSummary> entries,
    ...
    std::ranges::stable_sort(view.all, [currentScenario](const BrowseSummary* left,
                                                        const BrowseSummary* right) {
