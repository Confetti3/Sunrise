...
[[nodiscard]] inline const char* object_type_name(std::uint8_t type) noexcept {
    ...
    case 0x01: return "Static mesh";
    case 0x02: return "Simple prop (deprecated)";
    case 0x03: return "Expensive prop (deprecated)";
    case 0x04: return "Cosmetic static prop";
    case 0x05: return "Cosmetic movable prop";
    case 0x06: return "Garbage movable prop";
    case 0x07: return "Networked static prop";
    case 0x08: return "Networked movable prop";
    case 0x09: return "Cinematic prop";
    case 0x0A: return "Speedtree";
    case 0x0B: return "Interactive object";
    case 0x0C: return "Biped";
    case 0x0D: return "Creature";
    case 0x0E: return "Weapon";
    case 0x0F: return "Vehicle";
    case 0x10: return "Turret";
    case 0x11: return "Emitter";
    case 0x12: return "Projectile";
    case 0x13: return "Item";
    case 0x14: return "Ammo item";
    case 0x15: return "Loot item";
    case 0x16: return "Gear";
    case 0x17: return "Hop-on";
    case 0x18: return "Hop-on gear biped";
    case 0x19: return "Hop-on gear weapon";
    case 0x1A: return "Hop-on gear ship";
    case 0x1B: return "Hop-on gear sparrow";
    case 0x1C: return "System object";
    case 0xFF: return "Invalid object";
...
inline void append_objects(Graph& graph,
    ...
    for (std::size_t index = 0; index < snapshot.objectCount; ++index) {
        ...
        node.searchText = std::string("live runtime object system ")
                          + object_type_name(observation.type);
    ...
    diagnostics.push_back(
        {snapshot.truncated ? Diagnostic::Severity::warning
...
inline void append_triggers(Graph& graph,
    ...
    if (!result.triggerGroup) {
        diagnostics.push_back(
            {Diagnostic::Severity::error, "The inspection graph could not create the trigger group."});
        return;
    }
...
inline void update_triggers(Graph& graph,
    ...
    for (std::size_t index = 0; index < nodeIds.size(); ++index) {
        ...
        node->triggerOverlapCount = observation.kind == triggers::Kind::volume
                                        ...
                                        : std::nullopt;
        node->name = observation.kind == triggers::Kind::volume
                         ? std::string("Havok trigger volume")
                               + (observation.active ? " (occupied)" : "")
