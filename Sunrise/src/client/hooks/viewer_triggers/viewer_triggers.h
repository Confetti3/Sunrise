 ...
 *
 * @return True when both independent trigger observers were attached.
 */
 ...
 * @return True
 * when both replacements drained and detached.
 */
 ...
 * for the coherent bounded snapshot.
 * @return True when at least one trigger observation has been
 * published.
 */
[[nodiscard]] bool snapshot(Snapshot& output) noexcept;
/** @return True while both trigger replacements are attached. */
