...
public static class SelfTest
{
    ...
    private static void VerifyBoundedUtf8LineBuffer()
    {
        ...
        // A two-byte UTF-8 sequence split across pushes still decodes after the newline.
        ...
        // CRLF: one terminal carriage return is removed.
        ...
        // Exactly 2,048 bytes then newline is a valid line.
        ...
        // The next non-newline byte after capacity returns Oversized without creating a string.
        ...
        // The buffer resets after Oversized; a fresh line is accepted.
        ...
        // Malformed UTF-8 completes as InvalidUtf8, then the buffer resets for a valid line.
    ...
    private static async Task VerifyNamedPipeBridgeAsync()
    {
        ...
        try
        {
                ...
                await ConnectWithRetryAsync(pipeName, cts.Token).ConfigureAwait(false))
            {
                ...
                {
                    // The bridge may break the pipe once it detects the oversized line.
                }
